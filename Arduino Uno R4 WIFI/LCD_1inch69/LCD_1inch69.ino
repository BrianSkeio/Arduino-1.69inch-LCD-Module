...
void loop()
{
    ...
    Paint_DrawString_CN(235, 10, "中", &Font24BG, WHITE, RED);
    Paint_DrawString_CN(235, 50, "文", &Font24BG, WHITE, RED);
    Paint_DrawString_CN(235, 90, "字", &Font24BG, WHITE, RED);
    Paint_DrawString_CN(235, 130, "庫", &Font24BG, WHITE, RED);
    ...
    Paint_DrawString_CN(10, 150, "中文字庫", &Font24BG, WHITE, RED);
